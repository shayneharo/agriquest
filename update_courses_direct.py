#!/usr/bin/env python3
"""
AgriQuest - Direct Database Course Update
Updates courses directly through PostgreSQL database connection
"""
...
def get_database_connection():
    """Get database connection from environment or prompt user"""
    database_url = os.getenv('DATABASE_URL')
    
    if not database_url:
        print("🔌 Database Connection")
        print("=" * 40)
        print("I need your PostgreSQL database connection string.")
        print("You can find this in your Render dashboard:")
        print("1. Go to your Render PostgreSQL database")
        print("2. Copy the 'External Database URL'")
        print("3. It should look like: postgresql://user:password@host:port/database")
        print()
...
def main():
    ...
    print("🌱 AgriQuest - Direct Database Course Update")
    print("=" * 60)
    print("This will update your PostgreSQL database with proper BS Agriculture courses")
